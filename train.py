...
# Our datasets
x1, servo1 = get_servo_dataset('data/output_2.csv', start_index=35, output=5)
x2, servo2 = get_servo_dataset('data/output_3.csv', start_index=5, end_index=520, output=5)
X = x1 + x2
SERVO = servo1 + servo2
...
# for now, outputs = 10
servo_model = get_cnn_model(checkpoint_path='cnn_servo_model', output=5, **SETTINGS)
